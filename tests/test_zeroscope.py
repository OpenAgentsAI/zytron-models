...
from zytron_models.zeroscope import ZeroscopeTTV


@patch("zytron.models.zeroscope.DiffusionPipeline")
@patch("zytron.models.zeroscope.DPMSolverMultistepScheduler")
