...
from zytron_models.huggingface import HuggingfaceLLM
...
# @patch("zytron.models.huggingface.AutoTokenizer.from_pretrained")
# @patch(
#     "zytron.models.huggingface.AutoModelForCausalLM.from_pretrained"
# )
...
@patch("zytron.models.huggingface.HuggingfaceLLM.run")
...
@patch("zytron.models.huggingface.HuggingfaceLLM._tokenizer.encode")
@patch("zytron.models.huggingface.HuggingfaceLLM._tokenizer.decode")
...
@patch("zytron.models.huggingface.logging.warning")
...
@patch(
    "zytron.models.huggingface.HuggingfaceLLM._model.generate",
...
@patch("zytron.models.huggingface.HuggingfaceLLM._model")
