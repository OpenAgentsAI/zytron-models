...
from zytron_models.gemini import Gemini
...
@patch("zytron.models.gemini.Gemini.process_img")
@patch("zytron.models.gemini.genai.GenerativeModel.generate_content")
...
@patch("zytron.models.gemini.Gemini.chat")
...
@patch("zytron.models.gemini.Gemini.list_models")
...
@patch("zytron.models.gemini.Gemini.stream_tokens")
...
@patch("zytron.models.gemini.Gemini.process_img_pil")
